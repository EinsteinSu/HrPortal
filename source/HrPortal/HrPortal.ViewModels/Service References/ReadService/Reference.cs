...
namespace HrPortal.ViewModels.ReadService {
    ...
    public interface IReadService {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IReadService/GetEnterpriseUserJson", ReplyAction="http://tempuri.org/IReadService/GetEnterpriseUserJsonResponse")]
        System.IAsyncResult BeginGetEnterpriseUserJson(string userID, System.AsyncCallback callback, object asyncState);
        
        string EndGetEnterpriseUserJson(System.IAsyncResult result);
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IReadService/GetComments", ReplyAction="http://tempuri.org/IReadService/GetCommentsResponse")]
        System.IAsyncResult BeginGetComments(int issueID, System.AsyncCallback callback, object asyncState);
        
        string EndGetComments(System.IAsyncResult result);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GetEnterpriseUserJsonCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        public GetEnterpriseUserJsonCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
    ...
    public partial class ReadServiceClient : System.ServiceModel.ClientBase<HrPortal.ViewModels.ReadService.IReadService>, HrPortal.ViewModels.ReadService.IReadService {
        ...
        private BeginOperationDelegate onBeginGetEnterpriseUserJsonDelegate;
        
        private EndOperationDelegate onEndGetEnterpriseUserJsonDelegate;
        
        private System.Threading.SendOrPostCallback onGetEnterpriseUserJsonCompletedDelegate;
        ...
        public event System.EventHandler<GetEnterpriseUserJsonCompletedEventArgs> GetEnterpriseUserJsonCompleted;
        ...
        System.IAsyncResult HrPortal.ViewModels.ReadService.IReadService.BeginGetEnterpriseUserJson(string userID, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetEnterpriseUserJson(userID, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string HrPortal.ViewModels.ReadService.IReadService.EndGetEnterpriseUserJson(System.IAsyncResult result) {
            return base.Channel.EndGetEnterpriseUserJson(result);
        }
        
        private System.IAsyncResult OnBeginGetEnterpriseUserJson(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string userID = ((string)(inValues[0]));
            return ((HrPortal.ViewModels.ReadService.IReadService)(this)).BeginGetEnterpriseUserJson(userID, callback, asyncState);
        }
        
        private object[] OnEndGetEnterpriseUserJson(System.IAsyncResult result) {
            string retVal = ((HrPortal.ViewModels.ReadService.IReadService)(this)).EndGetEnterpriseUserJson(result);
            return new object[] {
                    retVal};
        }
        
        private void OnGetEnterpriseUserJsonCompleted(object state) {
            if ((this.GetEnterpriseUserJsonCompleted != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.GetEnterpriseUserJsonCompleted(this, new GetEnterpriseUserJsonCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }
        
        public void GetEnterpriseUserJsonAsync(string userID) {
            this.GetEnterpriseUserJsonAsync(userID, null);
        }
        
        public void GetEnterpriseUserJsonAsync(string userID, object userState) {
            if ((this.onBeginGetEnterpriseUserJsonDelegate == null)) {
                this.onBeginGetEnterpriseUserJsonDelegate = new BeginOperationDelegate(this.OnBeginGetEnterpriseUserJson);
            }
            if ((this.onEndGetEnterpriseUserJsonDelegate == null)) {
                this.onEndGetEnterpriseUserJsonDelegate = new EndOperationDelegate(this.OnEndGetEnterpriseUserJson);
            }
            if ((this.onGetEnterpriseUserJsonCompletedDelegate == null)) {
                this.onGetEnterpriseUserJsonCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnGetEnterpriseUserJsonCompleted);
            }
            base.InvokeAsync(this.onBeginGetEnterpriseUserJsonDelegate, new object[] {
                        userID}, this.onEndGetEnterpriseUserJsonDelegate, this.onGetEnterpriseUserJsonCompletedDelegate, userState);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult HrPortal.ViewModels.ReadService.IReadService.BeginGetComments(int issueID, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetComments(issueID, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string HrPortal.ViewModels.ReadService.IReadService.EndGetComments(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetComments(object[] inValues, System.AsyncCallback callback, object asyncState) {
            int issueID = ((int)(inValues[0]));
            return ((HrPortal.ViewModels.ReadService.IReadService)(this)).BeginGetComments(issueID, callback, asyncState);
        }
        
        private object[] OnEndGetComments(System.IAsyncResult result) {
            string retVal = ((HrPortal.ViewModels.ReadService.IReadService)(this)).EndGetComments(result);
            return new object[] {
                    retVal};
        }
        ...
        public void GetCommentsAsync(int issueID) {
            this.GetCommentsAsync(issueID, null);
        }
        
        public void GetCommentsAsync(int issueID, object userState) {
            ...
            base.InvokeAsync(this.onBeginGetCommentsDelegate, new object[] {
                        issueID}, this.onEndGetCommentsDelegate, this.onGetCommentsCompletedDelegate, userState);
        }
        ...
        private class ReadServiceClientChannel : ChannelBase<HrPortal.ViewModels.ReadService.IReadService>, HrPortal.ViewModels.ReadService.IReadService {
            ...
            public System.IAsyncResult BeginGetEnterpriseUserJson(string userID, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = userID;
                System.IAsyncResult _result = base.BeginInvoke("GetEnterpriseUserJson", _args, callback, asyncState);
                return _result;
            }
            
            public string EndGetEnterpriseUserJson(System.IAsyncResult result) {
                object[] _args = new object[0];
                string _result = ((string)(base.EndInvoke("GetEnterpriseUserJson", _args, result)));
                return _result;
            }
            ...
            public System.IAsyncResult BeginGetComments(int issueID, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = issueID;
            ...
            public string EndGetComments(System.IAsyncResult result) {
                object[] _args = new object[0];
                string _result = ((string)(base.EndInvoke("GetComments", _args, result)));
                return _result;
            }
        }
    }
